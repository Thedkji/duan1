    ...
    <div class="container">
        <div class="row row-25">
            ...
            <div class="footer-widget col-lg-3 col-md-6 col-sm-6 col-12 mb-40 mb-xs-35">
                ...
                <ul class="address">
                    <li><i class="fa fa-home"></i><span>Ngách 142-Phường Xuân Đỉnh-Bắc Từ Liêm-Hà Nội,
                        Vietnam</span>
                </li>
                <li><i class="fa fa-phone"></i><span><a href="#">(08) 55067815</a></span></li>
                <li><i class="fa fa-envelope-o"></i><span><a href="#">manhdxph35470@fpt.edu.vn</a></span>
                </li>
                </ul>
